...
namespace hh::game {
    ...
    //         return Create(allocator, type, &RESOLVE_STATIC_VARIABLE(T::typeInfo));
    //     }
    ...
    UCSL_NEWTYPE_STRUCT(ObjectData, ucsl::resources::object_world::v3::ObjectData<millersdk::ucsl::AllocatorSystem>, ObjectData);
    UCSL_NEWTYPE_STRUCT(ObjectWorldData, ucsl::resources::object_world::v3::ObjectWorldData<millersdk::ucsl::AllocatorSystem>, ObjectWorldData);
